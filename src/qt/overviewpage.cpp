    ...
    txdelegate(new TxViewDelegate(this))
{
    ...
    connect(ui->pollLabel, &ClickLabel::clicked, this, &OverviewPage::handlePollLabelClicked);
...
void OverviewPage::setResearcherModel(ResearcherModel *researcherModel)
{
    ...
    connect(ui->beaconButton, &QPushButton::clicked, this, &OverviewPage::onBeaconButtonClicked);
}
