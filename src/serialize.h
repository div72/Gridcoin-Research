...
{
    uint16_t obj;
    s.read(AsWritableBytes(Span{&obj, 2}));
    return le16toh(obj);
}
...
{
    uint32_t obj;
    s.read(AsWritableBytes(Span{&obj, 4}));
    return le32toh(obj);
}
...
{
    uint64_t obj;
    s.read(AsWritableBytes(Span{&obj, 8}));
    return le64toh(obj);
}
